    ...
    <>
      {
        friendRequests.length === 0 ? (
          ...
          friendRequests.map((request) => (
            <div key={request.senderId} className="flex gap-4 items-cemter">
              ...
              <button aria-label="deny friend" className='w-8 h-8 bg-red-600 hover:bg-rd-700 grid place-items-center rounded-full transition hover:shadow-md' onClick={() => denyFriend(request.senderId)}>
